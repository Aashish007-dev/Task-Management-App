    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm'>
        ...
        <div className="relative w-full max-w-md mx-4 overflow-hidden rounded-2xl shadow-xl border border-white/20 bg-white/90 backdrop-blur-lg transform transition-all duration-300 ease-out">
            <div className="flex items-center justify-between px-6 py-4 border border-gray-100">
                ...
                <button onClick={onClose} className='p-1 rounded-full hover:bg-gray-100 transition-colors duration-200 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-300 cursor-pointer'>
