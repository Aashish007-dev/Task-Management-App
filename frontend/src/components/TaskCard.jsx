...
const TaskCard = ({title, description, status, dueDate, priority, createdAt, progress, assignedTo, attachmentCount, completedTodoCount, todoCheckList, onClick}) => {
  ...
  return (
    <div className="bg-white rounded-xl px-4 shadow-md shadow-gray-100 border border-gray-200/50 cursor-pointer" onClick={onClick}>
        ...
        <div className={`px-4 border-l-[3px] ${status === 'In Progress' ? "border-cyan-500" : status === "Completed" ? "border-indigo-500" : "border-violet-500"}`}>
            ...
            <p className="text-sm text-gray-500 mt-1.5 line-clamp-2 leading-[18px]">{description}</p>
