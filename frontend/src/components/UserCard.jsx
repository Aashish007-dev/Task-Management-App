    ...
    <div className='p-2 bg-white rounded-xl shadow-md shadow-gray-100 border border-gray-200/50'>
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
                <img src={userInfo?.profileImageUrl} alt={userInfo?.name} className='h-12 w-12 rounded-full object-cover border border-gray-200' />
                <div>
...
const StatCard = ({label, count, status}) => {
    ...
    return (
        <div className={`flex flex-1 text-[10px] font-medium ${getStatusColors()} px-4 py-0.5 rounded-lg items-center gap-1`}>
